...
greeting=()=>{
  return `Hi my name is ${this.name}, this student is enrolled into 301`;
...
let hunter = new Student1('hunter', 25, 'Reno')

console.log(hunter.greeting());
...
//   }
// }
// let person = new Person("Joe", "Schmoe", 100);
...
//this binds to the scope call
// 2. What is "this" when joe.scopeArrow() is invoked?
//this refers to the name of the function
// 3. Explain why "this" is different when an arrow function is used.
//because the arrow function retains the this value of property
